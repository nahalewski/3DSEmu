...
M.provider = require("fold3ds.emuprovider")({
  ...
  systems = { ds = true },
  folderName = N,
  folderSub = "DS settings and tools",
  items = {
    ...
    { id = "nds_about", name = "About " .. N, sub = "The cores and where the art comes from", url = "page?id=about" },
  },
  setupTile = { id = "nds_setup", name = "Set Up " .. N, sub = "Let " .. N .. " keep its folder on the phone's storage",
    url = "act?id=storage" },
  addTile = { id = "nds_add", name = "Add DS Games", sub = "Pick a game, or copy games into the " .. N .. " folder",
    url = "act?id=add" },
})
